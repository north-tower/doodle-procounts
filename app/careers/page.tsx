...
function page() {
  ...
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="text-center">
      ...
      <h2 className="text-3xl font-bold leading-tight sm:text-4xl lg:text-5xl">Welcome to your new career</h2>
...
we play hard and work hard, ensuring that every day is both fulfilling and fun..</p>
  ...
  <div className="mx-auto max-w-xl px-4 py-10  lg:max-w-screen-lg">
    <h2 className="mb-8 text-3xl font-bold  lg:mb-20 lg:text-center lg:text-5xl">
