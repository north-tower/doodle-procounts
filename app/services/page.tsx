...
function page() {
  ...
  <div  className="col-span-1 flex flex-col justify-center text-center sm:text-left md:pr-10">
    ...
    <p  className="text-gray-600">Experience expert bookkeeping that grows with your business, offering accuracy, compliance, and peace of mind at every step.</p>
  </div>
  ...
  md:grid-cols-2 lg:mt-0">
    <div  className="relative flex gap-5">
      ...
      <div  className=""> 
        ...
        <p  className="text-gray-600 mt-3">Begin your journey with a comprehensive consultation to understand your unique business 
    ...
    <div  className="relative flex gap-5">
      ...
      <div  className="">
        ...
        <p  className="text-gray-600 mt-3">Stay informed with our detailed monthly and quarterly financial reports, including profit and loss statements, balance sheets, and cash flow reports. We also handle your tax calculations and prepare all necessary tax-compliant reports, ensuring you’re always ready for tax season.</p>
      </div>
    </div>
    <div  className="relative flex gap-5">
